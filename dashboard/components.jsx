  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-right">
        ...
        <a className="admin-btn" href="https://script.google.com/macros/s/AKfycbyrV3BrZ9DH3N_iei9JNDhQaZtvzguYVLMctCiwpLw-VuTyBut8svHcixrylG7yX4J_/exec" target="_blank" rel="noopener noreferrer" title="Admin Sync">
